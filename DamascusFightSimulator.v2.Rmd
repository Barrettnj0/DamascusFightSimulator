---
title: "Damascus Fight Simulator"
author: "Bares"
date: "11/14/2020"
output:
...
Instructions: 
1.Input both your and enemy stats for all initial values.
2.Run the chunk/file (for those new to R Markdown, you can click the green arrow in the top right of the green box below).
3.Check the bottom of the page for the probabilities/99.9% confidence interval for probability.

Notes:
-This simulator is still a WIP so please do not take it as law.
-This simulates fights by hand so please change the sample size to a smaller n value if lower processing power (Change n <- 10000 to n <- 1000 at the bottom of the chunk).
-Feel free to DM MrBares questions on discord.
